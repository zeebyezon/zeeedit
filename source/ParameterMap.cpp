...
const std::vector<settings::WidgetPanel>& ParameterMap::getPanels()
{
    ...
    //   Panel name,  width    Param name         Msg  Ch   CC#    min  max  inc  def
        ...
        {{"OSC A",     8_w}, {{"Frequency",      {CC,  7,   3  }, {0,   120, 1,   48 }},
                              {"SAW",            {CC,  7,   15 }, {0,   1,   1,   1  }},
                              {"SQU",            {CC,  7,   20 }, {0,   1,   1,   0  }},
                              {"Pulse Width",    {CC,  7,   21 }, {0,   120, 1,   60 }},
                              {"Sync",           {CC,  7,   23 }, {0,   1,   1,   0  }} }},
        {{"OSC B",    12_w}, {{"Frequency",      {CC,  7,   9  }, {0,   120, 1,   48 }},
                              {"Fine Tune",      {CC,  7,   14 }, {0,   127, 1,   0 }},
                              {"SAW",            {CC,  7,   30 }, {0,   1,   1,   1  }},
                              {"TRI",            {CC,  7,   52 }, {0,   1,   1,   0  }},
                              {"SQU",            {CC,  7,   116}, {0,   1,   1,   0  }},
                              {"Pulse Width",    {CC,  7,   22 }, {0,   120, 1,   60 }},
                              {"Low Freq",       {CC,  7,   24 }, {0,   1,   1,   0  }},
                              {"Keyboard",       {CC,  7,   25 }, {0,   1,   1,   1  }} }},
        {{"MIXER",     8_w}, {{"Osc A",          {CC,  7,   27 }, {0,   120, 1,   120 }},
                              {"Osc B",          {CC,  7,   28 }, {0,   120, 1,   0 }},
                              {"Noise",          {CC,  7,   29 }, {0,   120, 1,   0 }} }},
        {{"FILTER",   10_w}, {{"Rev",            {CC,  7,   41 }, {0,   1,   1,   0, {"1/2", "3"} }},
                              {"Cutoff",         {CC,  7,   73 }, {0,   120, 1,   120 }},
                              {"Resonance",      {CC,  7,   31 }, {0,   120, 1,   0 }},
                              {"Env Amount",     {CC,  7,   89 }, {0,   120, 1,   0 }},
        ...
        {{"ENVELOPE",  8_w}, {{"Attack",         {CC,  7,   104}, {0,   120, 1,   0 }},
                              {"Decay",          {CC,  7,   106}, {0,   120, 1,   60 }},
                              {"Sustain",        {CC,  7,   108}, {0,   120, 1,   120}},
                              {"Release",        {CC,  7,   110}, {0,   120, 1,   0  }} }},
        ...
        {{"GENERAL",   8_w}, {{"Glide rate",     {CC,  7,   26 }, {0,   120, 1,   0  }},
                              ...
                              {"Master Volume",  {CC,  7,   7  }, {0,   120, 1,   120 }} }},
    };
    return panels;
}
